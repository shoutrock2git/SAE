...
void ofApp::draw(){
    ...
    for(int i=0;i<flock.size();i++){
        Boid2d * b =flock.get(i);
        dis1= (redX*5 - b->x)*(redX*5 - b->x)+(redY*3 - b->y)*(redY*3 - b->y);
        dis2= (greenX*5 - b->x)*(greenX*5 - b->x)+(greenY*3 - b->y)*(greenY*3 - b->y);
        dis3= (blueX*5 - b->x)*(blueX*5 - b->x)+(blueY*3 - b->y)*(blueY*3 - b->y);
    ...
    if(dis1 <= 200*200){
        ofSetColor(color1);
        ofCircle(redX*5 ,redY*3, ofRandom(150));
        note = ofRandom(30, 70);
        velocity = 64;
        ...
        ofSetColor(color2);
        ofCircle(greenX*5 ,greenY*3, ofRandom(150));
        note = ofRandom(50, 100);
        velocity = 64;
        midiOut.sendNoteOn(2, note,  velocity);
    }else if (dis3<= 200*200){
        ofSetColor(color3);
        ofCircle(blueX*5 ,blueY*3, ofRandom(150));
        note = ofRandom(20, 80);
        velocity = 64;
    ...
    ofCircle(redX*5 ,redY*3, 10);
    ofSetColor(color2,80);
    ofCircle(greenX*5 ,greenY*3, 10);
    ofSetColor(color3,80);
    ofCircle(blueX*5 ,blueY*3, 10);
    
//    ofLine(redX*5,redY*3,blueX*5,blueY*3);
//    ofLine(blueX*5,blueY*3,greenX*5,greenY*3);
//    ofLine(greenX*5,greenY*3,redX*5,redY*3);
